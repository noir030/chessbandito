      ...
      mm.add("(min-width: 1000px)", () => {
        ...
        const scrollTrigger = ScrollTrigger.create({
          ...
          onUpdate: (self) => {
            ...
            const borderRadiusValue = progress <= 0.5 ? gsap.utils.mapRange(0, 0.5, 2, 0, progress) : 0;
  ...
  return (
    <section className="showreel" ref={showreelSecRef}>
      <div className="showreel-container">
        <img
          src={`/images/showreel/showreel-frame-${currentFrame}.jpeg`}
          alt="Showreel frame"
        />
      </div>
